...
const AnaliseCancelamentosModal = ({ open, onClose }: Props) => {
 ...
 <DialogContent className="max-w-2xl max-h-[90vh] overflow-hidden flex flex-col border-purple-500/20 p-0 [&>button]:text-primary-foreground/95 [&>button]:hover:text-primary-foreground">
