  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center px-4 animate-fade-in">
      ...
      <div className="relative w-full max-w-sm rounded-3xl border border-primary-foreground/[0.08] bg-charcoal/95 backdrop-blur-2xl shadow-[0_25px_60px_-12px_rgba(0,0,0,0.7)] px-7 py-6 space-y-4 animate-scale-in">
        <button
          onClick={handleClose}
          className="ios-press absolute top-4 right-4 w-8 h-8 rounded-full bg-primary-foreground/[0.08] flex items-center justify-center text-primary-foreground/85 hover:text-primary-foreground/80"
        >
          <X className="w-4 h-4" />
        </button>
        ...
        <header className="text-center space-y-1 pr-6">
          ...
          <p className="font-body text-[12px] text-primary-foreground/75 font-light leading-relaxed">
          ...
          <div className="space-y-4 pt-2">
            <div className="flex flex-col items-center gap-3 px-3 py-6 rounded-xl bg-success/10 border border-success/20">
              ...
              <p className="font-body text-[13px] text-primary-foreground/85 text-center leading-relaxed">
                ...
                <br />
                <span className="text-primary-foreground/85">Verifique sua caixa de entrada e spam.</span>
              </p>
            </div>
            <button
              onClick={handleClose}
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            <div className="space-y-1.5">
              ...
              <input
                ...
                className="w-full px-4 py-3 rounded-xl bg-primary-foreground/[0.05] border border-primary-foreground/[0.06] text-primary-foreground font-body text-[15px] placeholder:text-primary-foreground/85 focus:outline-none focus:ring-2 focus:ring-gold/20"
              />
            </div>
