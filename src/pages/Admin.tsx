        ...
        {tab === "clientes" && (() => {
          ...
          <div className="space-y-4 animate-fade-in">
            ...
            <Dialog open={!!selectedClient} onOpenChange={(o) => !o && setSelectedClient(null)}>
              <DialogContent className="w-[calc(100vw-2rem)] max-w-md max-h-[90vh] overflow-y-auto border border-gold/20 rounded-2xl p-5" style={{ backgroundColor: "hsl(var(--sidebar-background))" }}>
                <DialogHeader>
